...
*/
function temperatureInF(temperature, type) {
  if(type === 'F'){
...
function getName(name) {
  return 'Hello, my name is ' + name + ' , where ' + name + ' is stored in the object.' 
}
//console.log(getName(makePersonObject(5,'Leia','Leia@Leia.com').name));
